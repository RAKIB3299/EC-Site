...
<header class="nexora-header">
  <div class="nexora-header-inner">
    ...
    <div class="nexora-header-actions">
      <a class="nexora-icon-action nexora-search-action" href="${pageContext.request.contextPath}/products#q" aria-label="Search products"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="11" cy="11" r="7"/><path d="m20 20-4-4"/></svg></a>
